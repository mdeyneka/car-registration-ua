...
type VehicleRegistration struct {
	...
	EngineCapacity        uint32    `gorm:"type:uint32;column:enginecapacity" json:"eng_cap"`
	...
	NewRegistrationNumber string    `gorm:"type:varchar(16);column:newregistrationnumber" json:"new_reg_num"`
}
